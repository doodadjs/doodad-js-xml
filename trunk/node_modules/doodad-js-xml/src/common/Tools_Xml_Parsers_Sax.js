...
(function() {
	...
	global.DD_MODULES['Doodad.Tools.Xml.Parsers.Sax'] = {
		type: null,
		version: '0b',
		namespaces: null,
		...
		create: function create(root, /*optional*/_options) {
			...
			sax.parse = function(stream, /*optional*/options) {
				...
				return new Promise(function(resolve, reject) {
					...
					if (entities && (entities !== __Internal__.rawEntities)) {
						...
						parser.ENTITIES = __Internal__.entities;
					};
			...
			return function init(/*optional*/options) {
				...
				xml.loadXmlEntities(function(entities) {
					if (!types.isError(entities)) {
						__Internal__.rawEntities = entities;
						__Internal__.entities = __Internal__.reduceEntities(entities);
					};
				});
			};
		},
